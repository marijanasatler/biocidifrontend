        ...
        <h2 className=" font-weight-bold pl-4 text-muted pr-4 text-uppercase  " style={{color:'#5ab9ea'}}>{categorynabavke.nameSp}</h2>          
          <div>
             ...
             укупно набавки:{" "} <b style={{fontSize:'medium'}}> {nabavkes.length} </b> </p>}
                 ...
                 <div className='pl-4'>
                     {categorynabavke.name === 'javne nabavke' ? <p style={{color:'#5ab9ea',textTransform:'uppercase'}}>све јавне набавке завода за биоцид и медицинску екологију можете пронаћи на <a href='' style={{cursor:'pointer',color:'#5ab9ea'}}><b> порталу јавних набавки</b></a> </p> : null}
                 </div>
